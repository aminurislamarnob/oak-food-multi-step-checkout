...
<div class="enter-email-step enter-email-area">
	<h1><?php echo esc_html__('Checkout', 'oak-food-multi-step-checkout'); ?></h1>
	<div class="form-row form-row-wide">
		<label for="oak_billing_email" class="common-para common-label">
			<?php echo esc_html__('Enter your email address to complete your order.', 'oak-food-multi-step-checkout'); ?>
		</label>
		<span class="woocommerce-input-wrapper">
			<input type="email" class="input-text common-input" name="oak_billing_email" id="oak_billing_email" placeholder="<?php echo esc_attr('Your Email *'); ?>" value="<?php echo esc_attr(Helpers::get_loggedin_user_email()); ?>">
		</span>
	</div>
	<button id="checkout-first-step-btn" class="button next-btn common-bttn"><?php echo esc_html__('Next Page', 'oak-food-multi-step-checkout'); ?></button>

	<div class="payment-methods-logo">
		<a href="#">
			<img src="<?php echo plugins_url('assets/paypal.png', dirname(__FILE__)); ?>" alt="aa">
		</a>
		<a href="#">
			<img src="<?php echo plugins_url('assets/stripe.png', dirname(__FILE__)); ?>" alt="aa">
		</a>
		<a href="#">
			<img src="<?php echo plugins_url('assets/ideal.png', dirname(__FILE__)); ?>" alt="aa">
		</a>
	</div>
</div>
					...
					<div class="common-box">
						...
						<div class="white-box">
							<div class="create-account-hints">
								...
								<ul>
									<li>
										<img src="<?php echo plugins_url('assets/check.svg', dirname(__FILE__)); ?>" alt="C">
										Save for gifts and discounts
									</li>
									<li><img src="<?php echo plugins_url('assets/check.svg', dirname(__FILE__)); ?>" alt="C">
									Order faster</li>
									<li><img src="<?php echo plugins_url('assets/check.svg', dirname(__FILE__)); ?>" alt="C">
									View order history</li>
									<li><img src="<?php echo plugins_url('assets/check.svg', dirname(__FILE__)); ?>" alt="C">Follow Favorites</li>
									<li><img src="<?php echo plugins_url('assets/check.svg', dirname(__FILE__)); ?>" alt="C">Post Reviews</li>
								</ul>
							</div>
