...
<div class="oak-facts-section-wrapper">
	<div class="oak-facts-fields">
		...
		<div class="common-box">
			<div class="oak-facts-default-billing-fields">
				...
				<div class="different-billing-address">
					<div class="form-row form-row-wide">
						<input type="checkbox" name="different_billing_address" id="different_billing_address" <?php echo (Helpers::get_wc_session_value_by_key('different_billing_address') == 'on') ? 'checked' : ''; ?>
						>
			...
			<?php require pluginizelab_oak_food_multi_step_checkout()->get_template( 'checkout/oak-checkout-parts/different-billing-address.php' ); ?>
