...
final class OakFoodMultiStepCheckout {
     ...
     * @var array
     */
    private const OAK_FOOD_MULTI_STEP_CHECKOUT_DEPENEDENCIES = [
        'plugins' => [
    ...
    private function __construct() {
        ...
        register_activation_hook( OAK_FOOD_MULTI_STEP_CHECKOUT_FILE, [ $this, 'activate' ] );
        register_deactivation_hook( OAK_FOOD_MULTI_STEP_CHECKOUT_FILE, [ $this, 'deactivate' ] );
